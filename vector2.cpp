...
int main(int argc,char **argv)
{
    ...
    //Resolución último inciso del punto1
    vector1.pop_back();
    ...
    //Creo iterador (it) para el vector
    vector<int>::iterator it;
    //Uso un bucle, en este caso for para usar el iterador recien creado    
    cout <<"Impresion del vector usando un iterador" << endl;
